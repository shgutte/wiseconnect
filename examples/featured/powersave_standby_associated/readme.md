...
- Build the Wi-Fi - Powersave Standby Associated (SOC) or Wi-Fi - Powersave Standby Associated (NCP) or Powersave Standby Associated (PSRAM) example in Studio depending on your mode (SoC / NCP).
