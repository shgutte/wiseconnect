...
#### SoC Mode  
  ![Figure: Setup Diagram SoC mode for TLS Client Example](resources/readme/tlsclientsetupsoc.png)

#### NCP Mode 
  ![Figure: Setup Diagram NCP Mode for TLS Client Example](resources/readme/tlsclientsetupncp.png)
