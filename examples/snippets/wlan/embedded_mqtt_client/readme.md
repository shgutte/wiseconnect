...
- Select **Wi-Fi - Embedded MQTT Client(SOC)** test application
...
- Select **Wi-Fi -  Embedded MQTT Client(NCP)** test application

  **![project_selection](resources/readme/embedded_mqtt_example_ncp.png)**
