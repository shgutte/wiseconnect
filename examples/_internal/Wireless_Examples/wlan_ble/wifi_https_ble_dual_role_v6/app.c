  ...
  .boot_config = { .oper_mode       = SL_SI91X_CLIENT_MODE,
                   ...
                   .tcp_ip_feature_bit_map =
                     (SL_SI91X_TCP_IP_FEAT_DHCPV4_CLIENT | SL_SI91X_TCP_IP_FEAT_DHCPV6_CLIENT
                      | SL_SI91X_TCP_IP_FEAT_IPV6 | SL_SI91X_TCP_IP_FEAT_SSL | SL_SI91X_TCP_IP_FEAT_DNS_CLIENT
...
void rsi_common_app_task(void)
{
  ...
  wlan_app_thread_id = osThreadNew((osThreadFunc_t)rsi_wlan_app_task, NULL, &wlan_thread_attributes);
