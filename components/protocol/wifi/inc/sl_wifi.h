 ...
 *   This API performs following actions on TWT agreement: SUSPEND_INDEFINITELY, RESUME_INDEFINITELY, SUSPEND_FOR_DURATION.
 * @note
 ...
 * @param[in] twt_action
 *   Enum specifying different actions that can be taken in relation to rescheduling TWT.
 ...
 * | -------------------- | --------------------------------- |
 * | SUSPEND_INDEFINITELY | 0                                 |
 * | RESUME_IMMEDIATELY   | 0                                 |
 * | SUSPEND_FOR_DURATION | 1 to 86400000                     |
 * @return
 *   sl_status_t. See https://docs.silabs.com/gecko-platform/4.1/common/api/group-status for details.
 ******************************************************************************/
