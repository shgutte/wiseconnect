...
sl_status_t sl_si91x_host_bus_init(void);   /*Function used to enable DMADRV , GPIO pins and USART2 pins*/
void sl_si91x_host_enable_high_speed_bus(); /*Function used to set USART baurd rate to 20000000*/
void sl_si91x_host_gpio_init(void);         /*Function used to enable clock and configure SPI pins*/
void sl_si91x_host_usart2_init(void);       /*Function enables clock and USART interface pins*/
