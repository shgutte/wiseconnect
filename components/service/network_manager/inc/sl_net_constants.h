...
typedef enum {
  ...
  SL_NET_EAP_CLIENT_CREDENTIAL,   ///< WiFi EAP Credential
...
typedef enum {
  ...
  SL_NET_DEFAULT_WIFI_CLIENT_CREDENTIAL_ID = 1,        ///< WiFi Client Credential Id
  SL_NET_DEFAULT_WIFI_AP_CREDENTIAL_ID     = 2,        ///< WiFi Access Point Credential Id
  SL_NET_WIFI_EAP_CLIENT_CREDENTIAL_ID     = 3,        ///< WiFi EAP Client Credential Id
  SL_NET_WIFI_EAP_SERVER_CREDENTIAL_ID     = 4,        ///< WiFi EAP Server Credential Id
