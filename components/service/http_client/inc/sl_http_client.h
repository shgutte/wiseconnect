...
typedef struct {
  ...
  si91x_socket_type_length_value_t *sni_extension; ///< SNI extension address.
  uint8_t
 ...
 *   Pointer that holds SNI parameters.
 * @return
 *   sl_status_t. See https://docs.silabs.com/gecko-platform/4.1/common/api/group-status for details.
 ******************************************************************************/
sl_status_t si91x_set_sni_for_embedded_socket(si91x_socket_type_length_value_t *sni_extension);
