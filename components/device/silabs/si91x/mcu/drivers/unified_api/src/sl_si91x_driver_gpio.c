...
sl_status_t sl_gpio_driver_init(void)
{
  ...
  gpio_callback_function_pointer = NULL;
  return SL_STATUS_OK;
}
...
void PIN_IRQ0_Handler(void)
{
  ...
  gpio_callback_function_pointer(PIN_INTR_0);
}
...
void PIN_IRQ1_Handler(void)
{
  ...
  gpio_callback_function_pointer(PIN_INTR_1);
}
...
void PIN_IRQ2_Handler(void)
{
  ...
  gpio_callback_function_pointer(PIN_INTR_2);
}
...
void PIN_IRQ3_Handler(void)
{
  ...
  gpio_callback_function_pointer(PIN_INTR_3);
}
...
void PIN_IRQ4_Handler(void)
{
  ...
  gpio_callback_function_pointer(PIN_INTR_4);
}
...
void PIN_IRQ5_Handler(void)
{
  ...
  gpio_callback_function_pointer(PIN_INTR_5);
}
...
void PIN_IRQ6_Handler(void)
{
  ...
  gpio_callback_function_pointer(PIN_INTR_6);
}
...
void PIN_IRQ7_Handler(void)
{
  ...
  gpio_callback_function_pointer(PIN_INTR_7);
}
/*******************************************************************************
...
void GRP_IRQ0_Handler(void)
{
  ...
  gpio_callback_function_pointer(GROUP_INT_1);
}
...
void GRP_IRQ1_Handler(void)
{
  ...
  gpio_callback_function_pointer(GROUP_INT_2);
}
...
void UULP_PIN_IRQ_Handler(void)
{
  ...
  gpio_callback_function_pointer(flag);
}
...
void ULP_PIN_IRQ_Handler(void)
{
  ...
  if ((sl_si91x_gpio_driver_get_ulp_interrupt_status(ULP_PIN_INTR_8)) == ULP_STATUS) {
    sl_si91x_gpio_driver_clear_ulp_interrupt(ULP_PIN_INTR_8);
    flag |= ULP_PIN_INTR_8;
  }
  if ((sl_si91x_gpio_driver_get_ulp_interrupt_status(ULP_PIN_INTR_9)) == ULP_STATUS) {
    sl_si91x_gpio_driver_clear_ulp_interrupt(ULP_PIN_INTR_9);
    flag |= ULP_PIN_INTR_9;
  }
  if ((sl_si91x_gpio_driver_get_ulp_interrupt_status(ULP_PIN_INTR_10)) == ULP_STATUS) {
    sl_si91x_gpio_driver_clear_ulp_interrupt(ULP_PIN_INTR_10);
    flag |= ULP_PIN_INTR_10;
  }
  if ((sl_si91x_gpio_driver_get_ulp_interrupt_status(ULP_PIN_INTR_11)) == ULP_STATUS) {
    sl_si91x_gpio_driver_clear_ulp_interrupt(ULP_PIN_INTR_11);
    flag |= ULP_PIN_INTR_11;
  }
  gpio_callback_function_pointer(flag);
}
...
void ULP_GROUP_IRQ_Handler(void)
{
  ...
  if (sl_si91x_gpio_get_group_interrupt_status(SL_ULP_GPIO_PORT, GROUP_INT_1) == ULP_STATUS) {
    sl_si91x_gpio_driver_clear_ulp_group_interrupt(ULP_GROUP_INTR_0);
    flag |= ULP_GROUP_INTR_0;
  }
  if (sl_si91x_gpio_get_group_interrupt_status(SL_ULP_GPIO_PORT, GROUP_INT_2) == ULP_STATUS) {
    sl_si91x_gpio_driver_clear_ulp_group_interrupt(ULP_GROUP_INTR_1);
    flag |= ULP_GROUP_INTR_1;
  }
  gpio_callback_function_pointer(flag);
}
