...
#define SL_STATUS_CRYPTO_INVALID_PARAMETER \
  ((sl_status_t)0xCCFE) ///< Return when parameter passed to Crypto SAPI is invalid.
#define SL_STATUS_CRYPTO_INVALID_SIGNATURE \
  ((sl_status_t)0xCC9A) ///< Return in AEAD (CCM, GCM, Chachapoly) decryption function, when MAC generated during decryption does not match the MAC passed.
