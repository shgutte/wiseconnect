 ...
 * 
 * @pre \ref sl_si91x_power_manager_init \n
 * 
 ...
 * 
 * @param[in] none
 * @return sl_power_state_t enum value indicating current power state
 ******************************************************************************/
 ...
 * 
 * @param[in] none
 * @return Pointer to the uint8_t type array which contains 5 elements
 * 
 * Usage example:
 *  ```c
 * void main()
