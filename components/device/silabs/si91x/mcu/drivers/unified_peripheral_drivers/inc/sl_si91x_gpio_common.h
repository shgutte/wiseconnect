...
#define ULP_PIN_INTR_0  (1UL << 0)  ///< ULP GPIO pin interrupt 0
#define ULP_PIN_INTR_1  (1UL << 1)  ///< ULP GPIO pin interrupt 1
#define ULP_PIN_INTR_2  (1UL << 2)  ///< ULP GPIO pin interrupt 2
#define ULP_PIN_INTR_3  (1UL << 3)  ///< ULP GPIO pin interrupt 3
#define ULP_PIN_INTR_4  (1UL << 4)  ///< ULP GPIO pin interrupt 4
#define ULP_PIN_INTR_5  (1UL << 5)  ///< ULP GPIO pin interrupt 5
#define ULP_PIN_INTR_6  (1UL << 6)  ///< ULP GPIO pin interrupt 6
#define ULP_PIN_INTR_7  (1UL << 7)  ///< ULP GPIO pin interrupt 7
#define ULP_PIN_INTR_8  (1UL << 8)  ///< ULP GPIO pin interrupt 8
#define ULP_PIN_INTR_9  (1UL << 9)  ///< ULP GPIO pin interrupt 9
#define ULP_PIN_INTR_10 (1UL << 10) ///< ULP GPIO pin interrupt 10
#define ULP_PIN_INTR_11 (1UL << 11) ///< ULP GPIO pin interrupt 11

#define ULP_GROUP_INTR_0 (1UL << 0) ///< ULP GPIO group interrupt 0
#define ULP_GROUP_INTR_1 (1UL << 1) ///< ULP GPIO group interrupt 1
