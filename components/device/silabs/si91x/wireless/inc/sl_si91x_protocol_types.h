...
typedef struct {
  ...
  uint8_t nominal_pe;             ///< Nominal_pe 0-0Us 1-8Us 2-16Us
  uint8_t UL_DL;                  ///< UL_DL 0-PPDU sent by AP, 1-PPDU sent by STA to AP
  uint8_t he_ppdu_type;           ///< he_ppdu_type 0-HE SU PPDU, 1-HE ER SU PPDU, 2-HE TB PPDU, 3-HE MU PPDU
  uint8_t beam_change;            ///< beam_change 0-sameway, 1-differently
  uint8_t BW;                     ///< BW 0-242 tone RU, 1-Upper 106 tone RU
  uint8_t STBC;                   ///< STBC 0-no STBC, 1-STBC if only DCM is set to 0
  uint8_t Tx_BF;                  ///< TX_BF 0-no beamforming matrix, 1- beamforming matrix
  uint8_t GI_LTF;                 ///< GT_LTF shall be in the range 0-3
  uint8_t DCM;                    ///< DCM 0-No DCM, 1-DCM
  uint8_t NSTS_MIDAMBLE;          ///< NSTS_MIDAMBLE shall be in the range 0-7
  uint8_t spatial_reuse;          ///< spatial_reuse shall be in the range 0-15
  uint8_t BSS_color;              ///< BSS_COLOR shall be in the range 0-63
  uint16_t HE_SIGA2_RESERVED;     ///< HE_SIGA2_RESERVED shall be in the range 0-511
  uint8_t RU_ALLOCATION;          ///< RU_ALLOCATION shall be in the range 0-255
  uint8_t N_HELTF_TOT;            ///< N_HELTF_TOT shall be in the range 0-7
  uint8_t SIGB_DCM;               ///< SIGB_DCM 0-disable, 1-enable
  uint8_t SIGB_MCS;               ///< SIGB_MCS shall be in the range 0-5
  uint16_t USER_STA_ID;           ///< USER_STA_ID shall be in the range 0-2047
